...
function customerdeletion(cartCount,ordersCount)
{
	//alert(cartCount+ordersCount);
	if(cartCount > 0 || ordersCount > 0)
	{
		var message = "Customer has \n";
		if(cartCount > 0)
			message += cartCount + " - prodcuts in cart \n";
		if(ordersCount > 0)
			message += ordersCount + " - orders \n";
