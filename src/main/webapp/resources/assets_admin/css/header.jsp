...
<!--
<div class="playstore">
<a href="https://play.google.com/store/apps/details?id=com.adrobe.consumer.activities&hl=en"><img alt="Adnigam" src="<spring:url value="/resources/assets/playstoreIcon.png"/>"/></a>
</div> -->
<div class="hidden-xs" align="center" style="background:#f6f6f6;color: #00207D;  font-family: candara; font-size: 15px;font-weight: bold;">
<marquee>We are now in Warangal, Karimnagar, Khammam, Nizamabad, Nalgonda, Vijayawada, Vizag, Kakinada and Guntur.* Delivery within 48 hrs.*</marquee>
</div>
<div id="header" class="header">
    <div class="top-header">
        <div class="container hidden-xs">
            <div class="nav-top-links text-center">
                <a class="first-item" href="#"><img alt="phone" src="<spring:url value="/resources/images/phone.png"/>" /><spring:message code="adrobe.phone"/></a>
                <a href="mailto:<spring:message code="adrobe.email"/>"><img alt="email" src="<spring:url value="/resources/images/email.png"/>" />Email</a>
...
<div class="language ">
    <div class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <div class="support-link text-center hidden-xs">
                <c:if test="${empty sessionScope.USER}">
				     <a href="http://groceriesatadrobe.com/"><b>BUY GROCERIES</b></a>
    ...
    <!--/.top-header -->
    <!-- MAIN HEADER -->
    <div class="container main-header headerlogmenu">
        <div class="row">
        
        <div class="col-xs-2 hidden-lg hidden-md hidden-sm" id="box-vertical-megamenus">
                                        ...
                                        <a class="parent" href="<spring:url value="/ps/${category.seo_title}"/>"><img class="icon-menu" alt="${category.name}" src="<spring:url value="${categoryPath}${category.categoryIcon}"/>">${category.name}</a>
                                            ...
                                            <div class="vertical-dropdown-menu">
                                                <div class="vertical-groups col-sm-12">
                                                    ...
                                                    <div class="mega-group col-sm-4" id="vertical-dropdown-menu-new">
            ...
            <div class="col-xs-6 col-sm-3 logo">
                <a href="<spring:url value="/"/>"><img alt="Adnigam Shop" src="<spring:url value="/resources/images/logo-2.png"/>" /></a>
            </div>
...
<div class="col-xs-2 hidden-lg hidden-md hidden-sm">
<div class="dropdown">
  <button class="btn btn-danger headermyaccbut dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-user"></i>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="#">Signup</a></li>
            ...
            <div class="col-xs-4 col-sm-5 header-search-box">
            ...
            <!-- Advanced Search -->
            <div class="col-xs-2 col-sm-2 col-md-2 advancedSearch">

                <ul class="list-inline">
                    <li>
                        <a class='advSearchBtn btn btn-default filterhomicon' data-placement='bottom' title="Price Range" href='#'><span class="glyphicon glyphicon-filter gi-2x brandColor "></span></a>
            ...
            <!-- ./Advanced Search -->
            <div id="cart-block" class="col-xs-5 col-sm-2 shopping-cart-box hidden-xs">
                <jsp:include page="miniCart.jsp"/>
            </div>
            ...
            <div class="col-xs-2 hidden-lg hidden-md hidden-sm">
            <a href="http://www.adnigam.com/ps/todayOffers" class="btn btn-danger headertodoff"><i class="fa fa-gift"></i></a>
</div>
    ...
    <div id="nav-top-menu" class="nav-top-menu">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-xs-12 hidden-xs" id="box-vertical-megamenus">
                    <div class="box-vertical-megamenus">
                        <h4 class="title">
                ...
                <div id="main-menu" class="col-md-9 col-xs-3 hidden-xs main-menu">
                                    ...
                                    <li class="active"><a href="<spring:url value="/index"/>">Home</a></li>
                                        ...
                                        <li>
                                            <a href="<spring:url value="/ps/${category.seo_title}"/>">${category.name}</a>
                                                              ...
                                                              <li>
                                        <a href="http://www.adnigam.in"><h3>  Services</h3></a>
                                        </li>
                                </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <a id="zipAreaModalDismiss" href="#" data-dismiss="modal" class="pull-right"><span class="fa fa-close"></span></a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        zipcodeModal.find("button").click(function(e) {
            ...
            document.location.href = "<%=request.getContextPath()%>/updateLocation?loc=" + location;
        });
        
        zipcodeModal.find("#zipAreaModalDismiss").click(function (e) {
            document.location.href = "<%=request.getContextPath()%>/updateLocation";
        });
