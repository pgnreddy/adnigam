...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<spring:url value="/resources/assets_admin/css/simplePagination.css"/>" />
    ...
    <body>
        ...
        <script src="<spring:url value="/resources/assets_admin/js/jquery.simplePagination.js"/>" type="text/javascript"></script>
