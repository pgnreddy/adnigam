        ...
        <div class="container" style="">
            <%--<div class="row">
                ...
                <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="row">
                        <img src="<spring:url value="/resources/assets_admin/images/add3.jpg"/>" class="profile-pick avatar img-thumbnail" alt="avatar">
                        <img src="<spring:url value="/resources/assets_admin/images/cover-promo.jpg"/>" class="image-responsive cover-promo" alt="bg">
                    </div>
                </div>
            </div>--%>
            <!-- edit form column -->
            ...
            <div class="col-md-5 col-sm-6 col-xs-12 personal-info">
                ...
                <div class="col-md-12 well margin-left-10">
                    <div class="form-group">
                        <form id="uploadVendorPromoForm" method="POST" enctype="multipart/form-data">
                        <label for="browse"></label>
                        <button id="browse" type="button" class="file-input btn btn-primary btn-sm btn-file btn-block">Browse&hellip; <input type="file" name="vendorPromo"></button>
                        </form>
                        <label for="saveVendorPromo"></label>
                        <button id="saveVendorPromo" type="button" class="btn btn-warning btn-sm btn-file btn-upload">Upload</button>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#saveVendorPromo").click(function() {
            var options = {
                url: '<spring:url value="/vendor/uploadVendorPromo"/>',
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                   if(data && data.status){
            ...
            $("#uploadVendorPromoForm").ajaxSubmit(options);
            return false;
        });
