    ...
    <header class="header black-bg">
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="images/customer_female.png"></span>
                                    <span class="subject">
                                    <span class="from">Divya</span>
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<spring:url value="/admin/logout"/>">Logout</a></li>
            	</ul>
            </div>
        </header>
