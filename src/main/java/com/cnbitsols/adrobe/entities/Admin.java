...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Admin.findAll", query = "SELECT a FROM Admin a  ORDER BY a.id DESC "),
...
public class Admin implements Serializable {
    ...
    public Admin(Integer id, int status) {
        this.id = id;
        this.status = status;
    }
    ...
    public String toString() {
        return "com.cnbitsols.adrobe.entities.Admin[ id=" + id + " ]";
    }
